...
class AdminController extends Controller
{
    ...
    public function alternativeCreate(Request $request)
    {
        DB::table('alternatives')->insert([
            'nama' => $request->nama,
            'kode' => $request->kode,
            'penciptaan_arsip' => $request->criteria[0],
            'pemindahan_arsip' => $request->criteria[1],
            'pemberkasan' => $request->criteria[2],
            'layanan_arsip' => $request->criteria[3],
            'pengelolaan_arsip' => $request->criteria[4],
